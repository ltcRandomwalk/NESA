...
oracle_path = os.path.join(reproduced_dir,f"neuro/pts/{sys.argv[1]}/rank-oracle.txt")
...
if not os.path.isfile(oracle_path):
    ...
    oracle_path = os.path.join(original_dir,f"neuro/pts/{sys.argv[1]}/rank-oracle.txt")
...
plt.savefig(os.path.join(reproduced_dir, f"RQ1/figure9/{sys.argv[1]}-{query}.pdf"), bbox_inches='tight')
