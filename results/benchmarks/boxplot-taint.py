...
out1_path = f"./taint/{sys.argv[1]}/rank-baseline.txt"
out2_path = f"./taint/{sys.argv[1]}/rank-our-approach-ICCmodel.txt"
oracle_path = f"./taint/{sys.argv[1]}/rank-oracle.txt"
