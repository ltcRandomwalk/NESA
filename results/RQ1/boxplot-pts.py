...
out1_path = f"../neuro/pts/{sys.argv[1]}/rank-baseline.txt"
out2_path = f"../neuro/pts/{sys.argv[1]}/rank-our-approach-small.txt"
oracle_path = f"../neuro/pts/{sys.argv[1]}/rank-oracle.txt"
