...
for varIndex in range(numVars):
    ...
    if ruleName != None and "Obs" in ruleName:
        probability = min(safeProb, ruleProbs[ruleName])
        outLines.append('3')
        outLines.append('0 1')
        outLines.append('2 {0}'.format(1-probability))
        outLines.append('3 {0}'.format(probability))
