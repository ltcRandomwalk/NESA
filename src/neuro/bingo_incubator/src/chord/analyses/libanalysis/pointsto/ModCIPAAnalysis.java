...
@Chord(
	name = "mod-cipa-java",
	consumes = { "VH1", "FH1", "HFH1" }
)
public class ModCIPAAnalysis extends JavaAnalysis {
	private ProgramRel relVH;
	private ProgramRel relFH;
	private ProgramRel relHFH;
	public void run() {
		relVH  = (ProgramRel) ClassicProject.g().getTrgt("VH1");
		relFH  = (ProgramRel) ClassicProject.g().getTrgt("FH1");
		relHFH = (ProgramRel) ClassicProject.g().getTrgt("HFH1");
	}
	/**
