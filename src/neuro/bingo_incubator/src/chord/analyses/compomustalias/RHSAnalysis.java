...
public abstract class RHSAnalysis<PE extends IEdge, SE extends IEdge> extends JavaAnalysis {
    ...
    protected Map<Inst, ArraySet<PE>> pathEdges = new HashMap<Inst, ArraySet<PE>>();
    protected Map<jq_Method, ArraySet<SE>> summEdges = new HashMap<jq_Method, ArraySet<SE>>();
    protected DomI domI;
    protected DomM domM;
    ...
    protected final ArraySet<jq_Method> getTargets(Quad i) {
