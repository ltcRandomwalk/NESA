...
public class Edge implements IEdge {
    ...
    public boolean isAppAccessed() {
    	if (srcNode != null && dstNode != null)
    		return srcNode.isAppAccessed() && dstNode.isAppAccessed();
    	else if (srcNode != null && dstNode == null)
    		return srcNode.isAppAccessed();
    	else if (srcNode == null && dstNode != null)
    		return dstNode.isAppAccessed();
    	else
    		return false;
    }
    
    public boolean subsumes(Edge other) {
    	boolean retval = true;
    	if (srcNode == null && other.srcNode != null)
    		return false;
    	else if (srcNode != null && other.srcNode != null) {
	    	for (AccessPath ap : other.srcNode.ms) {
	    		if (!srcNode.ms.contains(ap)) {
	    			retval = false;
	    			break;
	    		}
	    	}
