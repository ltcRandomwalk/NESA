package chord.analyses.mln.kobj.precg;
...
public class MLNKobjDriver extends MLNAnalysisDriver {
	...
	protected Set<String> getDomains() {
		...
		//domains from pro-cspa-kobj-precg-dlog
		ret.add("I");
		ret.add("T");
		ret.add("H");
		ret.add("M");
	...
	protected Set<String> getInputRelations() {
		...
		//input relations from pro-cspa-kobj-precg-dlog
		ret.add("epsilonM");
...
//		String kobjConfig = chordIncubator + File.separator + "src/chord/analyses/mln/kobj/pro-cspa-kobj-dlog_XZ90_.config";
		String kobjConfig = chordIncubator + File.separator + "src/chord/analyses/mln/kobj/precg/pro-cspa-kobj-precg-dlog_XZ89_.config";
		String clientConfig = chordIncubator + File.separator + clientConfigPath;
		String[] configFiles = new String[]{ kinitConfig, kobjConfig, clientConfig };
		return configFiles;
	}
	...
	protected void genTasks(){
		...
		tasks.add(ClassicProject.g().getTask("pro-cspa-kobj-precg-dlog_XZ89_"));
		if(client == 1)
