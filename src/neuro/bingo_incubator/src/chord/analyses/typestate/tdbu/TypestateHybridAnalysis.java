 ...
 * 
 */
@Chord(name = "hybrid-typestate-java", consumes = { "reachableFromM",
		"checkExcludedM" })
public class TypestateHybridAnalysis extends JavaAnalysis {
	private TypestateTopDownAnalysis td;
	private TypestateBottomUpAnalysis bu;
	...
	public TypestateHybridAnalysis() {
		init = false;
	}
	...
	public void init() {
		...
		td = new TypestateTopDownAnalysis(tdLimit, autoAdjustBU, jumpEmpty,
				buAllMethods, trackedSites,rmsFrRoots);
		td.init();
		bu = new TypestateBottomUpAnalysis(td.getCallGraph(), buLimit,
	...
	public void run() {
		...
		System.out.println("Total SE numbers " + seNum);
