...
public class TypestateTopDownAnalysis extends
		TopDownAnalysis<Edge, Edge, TypestateBUEdge, TypestateBUEdge> {
	...
	public TypestateTopDownAnalysis(int tdLimit, boolean autoAdjustBU,
...
//		maxDepth = Integer.getInteger("chord.mustalias.maxdepth", 2);
		maxDepth = 0; // Let's first hard code it as 0
		assert (maxDepth >= 0);


		cicg = TypestateHybridAnalysis.cicg;
		cipa = TypestateHybridAnalysis.cipa;
