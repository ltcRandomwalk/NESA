...
public class ProfileUtil {
  ...
  private static class Time {
    ...
    // TODO:
    //  Sometimes this code is triggered after on OoM exception.
    //  1.  Check if profiling code itself causes the memory consumption.
    //  2.  Regardless of 1, make sure that the code uses very little
    //      memory, so that a OoM is not thrown again.
