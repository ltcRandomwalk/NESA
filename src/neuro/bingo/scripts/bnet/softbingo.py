...
wrapperExecutable = '/home/tcli/neuro/bingo/libdai/wrapper'
...
with subprocess.Popen([wrapperExecutable, fgFileName], \
    ...
    statfile = open(testDir + '-post.txt', 'w')
    runAlarmCarousel(tolerance, minIters, maxIters, histLength, statfile, 'post', 'txt')
